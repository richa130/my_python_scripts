...
***************************************************************************
"""
handle_name = open("cake_ingredients_list.txt", "w")
...
def recipe(size, type):
    if size == "R":
        ...
        if type == 1:
            ...
            handle_name.write("Regular Chocolate Ingredient List:\n")
            handle_name.write("Flour: ")
            handle_name.write(str(flour))
            handle_name.write(" Oz\n")
            handle_name.write("Sugar: ")
            handle_name.write(str(sugar))
            handle_name.write(" Oz\n")
            handle_name.write("Cocoa Powder: ")
            handle_name.write(str(cocoa))
            handle_name.write(" Oz\n")
            handle_name.write("Baking Powder: ")
            handle_name.write(str(baking_powder))
            handle_name.write(" Oz\n")
            handle_name.write("Baking Soda: ")
            handle_name.write(str(baking_soda))
            handle_name.write(" Oz\n")
            handle_name.write("Salt: ")
            handle_name.write(str(salt))
            handle_name.write(" Oz\n")
            handle_name.write("Egg: ")
            handle_name.write(str(egg))
            handle_name.write(" Oz\n")
            handle_name.write("Buttermilk: ")
            handle_name.write(str(butter_milk))
            handle_name.write(" Oz\n")
            handle_name.write("Canola Oil: ")
            handle_name.write(str(canola_oil))
            handle_name.write(" Oz\n")
            handle_name.write("Vanilla Extract: ")
            handle_name.write(str(vanilla_extract))
            handle_name.write(" Oz\n")
            handle_name.write("Boiling Water: ")
            handle_name.write(str(boiling_water))
            handle_name.write(" Oz\n")
        if type == 2:
            ...
            handle_name.write("Regular Red Velvet Ingredient List\n")
            handle_name.write("Flour: ")
            handle_name.write(str(flour))
            handle_name.write(" Oz\n")
            handle_name.write("Sugar: ")
            ...
            handle_name.write(" Oz\n")
            handle_name.write("Cocoa Powder: ")
            handle_name.write(str(cocoa_powder))
            handle_name.write(" Oz\n")
            handle_name.write("Canola Oil: ")
            handle_name.write(str(canola_oil))
            handle_name.write(" Oz\n")
            handle_name.write("Buttermilk: ")
            handle_name.write(str(buttermilk))
            handle_name.write(" Oz\n")
            handle_name.write("Egg: ")
            handle_name.write(str(egg))
            handle_name.write(" Oz\n")
            handle_name.write("Red Food Coloring: ")
            handle_name.write(str(food_coloring))
            handle_name.write(" Oz\n")
            handle_name.write("Vanilla Extract: ")
            handle_name.write(str(vanilla_extract))
            handle_name.write(" Oz\n")
            handle_name.write("Distilled Vinegar: ")
            handle_name.write(str(distilled_vinegar))
            handle_name.write(" Oz\n")
        if type == 3:
            ...
            handle_name.write("Regular Lemon Ingredient List:\n")
            handle_name.write("Butter: ")
            handle_name.write(str(butter))
            handle_name.write(" Oz\n")
            handle_name.write("Sugar: ")
            handle_name.write(str(sugar))
            handle_name.write(" Oz\n")
            ...
            handle_name.write(str(vanilla_extract))
            handle_name.write(" Oz\n")
            handle_name.write("Egg Yolk Filling: ")
            handle_name.write(str(egg_yolk_filling))
            handle_name.write(" Oz\n")
            handle_name.write("Sugar Filling: ")
            handle_name.write(str(sugar_filling))
            handle_name.write(" Oz\n")
            handle_name.write("Butter Filling: ")
            handle_name.write(str(butter_filling))
            handle_name.write(" Oz\n")
            handle_name.write("Lemon Juice and Zest Filling: ")
            handle_name.write(str(lemon_juice_zest_filling))
            handle_name.write(" Oz\n")
    elif size == "L":
        ounces = 112
        if type == 1:
            ...
            print("Large Chocolate Ingredient List:\nFlour:", flour, "Oz\nSugar:", sugar, "Oz\nCocoa Powder:", cocoa,
                  ...
                  vanilla_extract,
                  "Oz\nBoiling Water:", boiling_water, "Oz")
            handle_name.write("Large Chocolate Ingredient List:\n")
            handle_name.write("Flour: ")
            handle_name.write(str(flour))
            handle_name.write(" Oz\n")
            handle_name.write("Sugar: ")
        ...
        if type == 2:
            ...
            print("Large Red Velvet Ingredient List:\nFlour:", flour, "Oz\nSugar:", sugar,
                  ...
                  "Oz\nRed Food Coloring:", food_coloring, "Oz\nVanilla Extract:", vanilla_extract,
                  "Oz\nDistilled Vinegar:", distilled_vinegar, "Oz")
            handle_name.write("Large Red Velvet Ingredient List\n")
            handle_name.write("Flour: ")
            handle_name.write(str(flour))
            handle_name.write(" Oz\n")
            handle_name.write("Sugar: ")
        ...
        if type == 3:
            ...
            print("Large Lemon Ingredient List:\nButter:", butter, "Oz\nSugar:", sugar, "Oz\nEgg:", egg, "Oz\nFlour:",
                  ...
                  "Oz")
            handle_name.write("Large Lemon Ingredient List:\n")
            handle_name.write("Butter: ")
            handle_name.write(str(butter))
            handle_name.write(" Oz\n")
            handle_name.write("Sugar: ")
...
orders = open("cake_orders.txt")

#for loop using that reads file and gets size and type from line
for line in orders:
    #print(line, end="")
    cake_num = eval(line[0])
    size = line[4]
    #print(cake_num, ":", size)
    recipe(size, cake_num)
